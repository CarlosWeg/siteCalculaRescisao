<section class="container-como-calcular container">
    ...
    <section class="item">
        ...
        <div class="explicacao">
            <div class="explicacao-texto">
                <p>
                    O saldo de salário corresponde ao valor proporcional referente aos dias trabalhados no mês em que ocorre a rescisão. Quando o empregado não completa o mês, é necessário calcular a fração do salário que lhe é devida.
                </p>
                <ul>
                    <li>
                        Divida o salário mensal pelo número total de dias do mês para encontrar o valor diário.
                    </li>
                    <li>
    ...
    <section class="item">
        ...
        <div class="explicacao">
            <div class="explicacao-texto">
                <p>
                    As férias podem ser classificadas em dois tipos: <em>férias vencidas</em>, que são aquelas cujo período aquisitivo já foi concluído, e <em>férias proporcionais</em>, que se referem ao período trabalhado desde o início do novo ciclo aquisitivo até a data da rescisão.
                </p>
                <ul>
                    <li>
                        Para férias vencidas, o empregado tem direito ao valor integral, acrescido de 1/3 constitucional.
                    </li>
                    <li>
    ...
    <section class="item">
        ...
        <div class="explicacao">
            <div class="explicacao-texto">
                <p>
                    O 13º salário, ou gratificação natalina, também deve ser calculado de forma proporcional quando o empregado não completa o ano de trabalho. O valor é determinado com base na quantidade de meses trabalhados.
                </p>
                <ul>
                    <li>
                        Divida o salário mensal por 12 para obter o valor correspondente a um mês de trabalho.
                    </li>
                    <li>
    ...
    <section class="item">
        ...
        <div class="explicacao">
            <div class="explicacao-texto">
                <p>
                    O aviso prévio pode ser trabalhado ou indenizado e tem como objetivo oferecer ao empregado um período para se ajustar à perda do emprego. O cálculo do aviso prévio indenizado considera o salário mensal e, em muitos casos, um acréscimo de 3 dias por ano trabalhado, limitado a 90 dias.
                </p>
                <ul>
                    <li>
                        Identifique o tempo de serviço do empregado para definir o número de dias adicionais.
                    </li>
                    <li>
    ...
    <section class="item">
        ...
        <div class="explicacao">
            <div class="explicacao-texto">
                <p>
                    Em caso de demissão sem justa causa, o empregador deve pagar uma multa de 40% sobre o total dos depósitos do Fundo de Garantia do Tempo de Serviço (FGTS). Essa multa é uma compensação pelo desligamento.
                </p>
                <ul>
                    <li>
                        Some todos os valores depositados no FGTS durante o contrato de trabalho.
                    </li>
                    <li>
