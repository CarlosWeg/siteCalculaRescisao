<footer class="w-full bg-blue-500 text-white">
    ...
    <div class="footer-paginas-disclaimer flex flex-col md:flex-row justify-center items-center max-w-7xl mx-auto p-6">
            
            <nav class="w-full max-w-7x1 mx-auto flex flex-col md:flex-row justify-around items-center mb-6 md:mb-0">

                <!--Menu navegação-->
                <ul class ="flex flex-col items-center gap-6 md:gap-8 mt-4 md:mt-0">
